...
class SaveDialogComponents {
                          ...
                          _buildFormSection(
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                isExpanded: true,
                                items: SaveDialogComponents._buildFileFormatItems(fileFormat), //동적 아이템 생성
                                onChanged: (value) => onFileFormatChanged(value ?? '.txt'),
                                style: const TextStyle(fontSize: 14, color: Colors.black),
                                dropdownColor: Colors.white,
                                menuMaxHeight: 200, // 적절한 높이로 설정
                                alignment: AlignmentDirectional.bottomStart, //항상 아래쪽으로 정렬
                              ),
                            ),
                          ),
                        ],
  ...
  static List<DropdownMenuItem<String>> _buildFileFormatItems(String selectedFormat) {
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              onPressed: (selectedFilePath != null && fileName.trim().isNotEmpty) ? onFileSave : null,
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF1F2937),
                foregroundColor: Colors.white,
                disabledBackgroundColor: const Color(0xFFD1D5DB),
