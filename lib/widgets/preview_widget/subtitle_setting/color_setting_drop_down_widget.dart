...
class _ColorSettingDropDownState extends State<ColorSettingDropDown> {
  ...
  static const _opacityBaseColor = Color.fromRGBO(
    33,
    150,
    243,
    1.0,
  ...
  // 폰트 크기
  double get _fontSize => AppSizes.baseFontSize;

  // === Color/Opacity 도우미 메서드들 ===

  /// 색상 이름을 Color 객체로 변환
  Color _getColorFromName(String colorName) =>
      _colorMap[colorName] ?? Colors.grey;
      ...
      child: ClipOval(
        child: Stack(
          children: [
            ...
            Container(
              color: _opacityBaseColor.withValues(alpha: opacity),
            ), // 불투명도 레이어
          ],
        ),
      ),
